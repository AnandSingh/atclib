...
{  
         ...
         while (true)
         {
             ...
             {    
                 ...
                 else 
                 {
                     ...
                     InsertAfterInt(randInts, insertAfterInt,removeInt);
    ...
    public void removeInt(ArrayList randInts, Integer n)
    {

       int index = -1;
       while( -1 != (index = randInts.lastIndexOf(n)))
       {
           randInts.remove(index);
       }
    }
    
    // Your declaration and definition of the ArrayListRemoveInsert's insert method goes here:
    public void InsertAfterInt(ArrayList randInts, Integer n, Integer removeInt)
    {
       int arraySize = randInts.size();
