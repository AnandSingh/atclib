...
public class BinarySearchTree<E> extends AbstractSet<E> implements java.io.Serializable
{
    ...
    /**
     * added height function for lab17
     *  wrapper function to detrmine height via recursive
     *  Auther: Anand Singh                        *	
     *  CWID  : A20280101                          *
     *  Email : asingh83@hawk.iit.edu              *
     *  Date  : 8-Mar-2012  
    ...
    /**
     * Helper function used in height function
     */
    ...
    /**
     * recursive function to determine the height
     */
	...
	{
		return (1 + max(h(p.left), h(p.right)));	
	}
    }
    ...
    protected class TreeIterator implements Iterator<E>
    {
         ...
         *  The worstTime(n) is O(n) and averageTime(n) is constant.
         *
         *  @throws IllegalStateException - if this TreeIteratornext() method was not
         *                called before this call, or if this TreeIteratorremove() method was
