...
*  Date  : 28-Mar-2012                        *
    ...
    protected Boolean addElement(E element, Entry<E> temp)
    {
	...
	else if (comp < 0)
	{
		...
		{
			return addElement(element, temp.left);
		}
	} else
        {
		if(temp.right == null)
		...
		{
			return addElement(element, temp.right);
		}
        }
    }
    /**
